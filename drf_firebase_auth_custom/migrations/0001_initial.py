    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('firebase_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='provider', related_query_name='provider', to='drf_firebase_auth_custom.FirebaseUser')),
            ],
        ),
    ]
