...
from drf_firebase_auth_custom.settings import api_settings
from drf_firebase_auth_custom.utils import (
...
class WhoAmITests(APITestCase):
    ...
    def setUp(self):
        ...
        self._MOCK_FIREBASE_CREATE_LOCAL_USER_FALSE = mock.patch(
            'drf_firebase_auth_custom.authentication.api_settings'
